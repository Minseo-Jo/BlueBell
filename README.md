...
<div style="display: flex; justify-content: center;">
  <img src="./image/ui-setup.png" width="600"/>
  <img src="./image/ui-setupresult.png" width="600"/>
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="./image/ui-code.png" width="600"/>
  <img src="./image/ui-coderesult.png" width="600"/>
</div>
...
#### 검색 및 성능 최적화
- 키워드와 의미 기반 검색을 결합한 매칭
- Python, Javascript 등 언어별 맞춤 컨벤션 검색
- 코딩 컨벤션과 환경 설정 템플릿을 1536차원 벡터로 변환 -> 키워드가 다르더라도 의미가 유사한 데이터를 정확히 찾아냄
